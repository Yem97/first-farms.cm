...
insert into public.testimonials (quote, farmer_name, region, featured) values
  ('Since joining Firstfarms, I have doubled my income by selling directly to buyers in Douala. No more middlemen taking our profits.', 'Celestin Bakam', 'Adamaoua', true),
  ...
  ('Firstfarms gave me access to tools, storage, and markets I never thought I could reach as a small farmer in the North.',            'Ibrahim Yaya',   'Nord',     true);
