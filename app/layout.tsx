...
export const metadata: Metadata = {
  ...
  description: "Firstfarms Digital Cooperative Cameroon is a youth- and women-led digital agricultural cooperative. Home of AgriExpert AI, our AI-powered agri-education and smart-farming platform across agriculture, livestock, fisheries, animal industries, forestry and wildlife.",
};
