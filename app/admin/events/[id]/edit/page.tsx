...
export default async function EditEventPage({ params }: { params: { id: string } }) {
  ...
  const { data: event } = await supabase.from("training_events").select("*").eq("id", params.id).single<TrainingEvent>();
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-bold font-poppins text-primary">Edit Event</h1>
      </div>
