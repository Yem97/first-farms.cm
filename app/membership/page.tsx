...
export default function MembershipPage() {
  ...
  const tiers = [
    ...
    },
    {
      ...
      features: ["Corporate sponsorship", "Large scale logistics", "Priority sourcing", "Branding opportunities"],
    ...
    <div className="pt-20">
      ...
      <section className="py-24 container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {tiers.map((t, i) => (
            <div key={i} className={`p-10 rounded-3xl flex flex-col h-full border ${t.highlight ? "bg-accent text-white border-accent shadow-2xl scale-105 z-10" : "bg-white border-gray-100 shadow-md"}`}>
